...
module.exports = function () {
  function VimeoService(avatarService) {
  ...
  _createClass(VimeoService, [{
    ...
    value: function getAvatar(username) {
      ...
      return this._avatarService.findImage('https://www.vimeo.com/' + username, 'vimeo').then(function (imageUrl) {
        return _this._avatarService.getImage(imageUrl, 'vimeo');
